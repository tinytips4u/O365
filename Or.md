1. Open powershell on your system as administrator. Then copy and paste this command, `irm https://massgrave.dev/get | iex` and press enter. This will open a command prompt windows with some options.
